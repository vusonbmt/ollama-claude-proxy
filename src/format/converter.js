...
import { DEFAULT_MAX_TOKENS, DEFAULT_TEMPERATURE, DEFAULT_TOP_P } from '../constants.js';
...
export function convertAnthropicToOllama(anthropicRequest) {
    const { model, messages, max_tokens, temperature, top_p, tools, system } = anthropicRequest;
...
export function convertOllamaToAnthropic(ollamaResponse, model) {
    ...
    if (message) {
        if (typeof message.content === 'string') {
            ...
            content = message.content.content || message.content.text || message.content || '';
